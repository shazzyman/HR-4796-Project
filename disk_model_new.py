...
def get_phase_new(nwl, na, a, wl, m_asi, m_ac, m_wi, f_asi, f_ac, f_wi, x_arr, m_arr,
...
def disk_model_fun_new(wl, amin, amax, aexp, mexp, f_asi, f_ac, f_wi, m_asi, m_ac, m_wi, 
    ...
    qsca, pg_tab = get_phase_new(nwl, na, a, wl, m_asi, m_ac, m_wi, f_asi, f_ac, f_wi, 
    ...
    sigma_num = sigma_up / np.trapz(
        (4. / 3.) * np.pi * (phi_pf * f_asi * 3.3 + phi_pf * f_ac * 2.2 + phi_pf * f_wi * 1.0) * ((a * 1e-4) ** 3) * abin, a)
