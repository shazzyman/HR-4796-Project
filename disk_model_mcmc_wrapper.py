#!/usr/bin/env python
"""
This Python script is designed to perform an MCMC (Markov Chain Monte Carlo) analysis of a dust disk model, leveraging MPI parallelization for 
...
# Set up MCMC
coords = np.random.randn(20, 10) # This is (number of chains, number of variables)
nwalkers, ndim = coords.shape
max_n = 10 # *max iterations* Should be much larger ~1k-10k the low number is just to test.
...
initial = h5py.File('MCMC_test.hdf5', 'w')
